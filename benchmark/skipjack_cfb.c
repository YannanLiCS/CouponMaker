...
void CFB_blk_encrypt(BYTE *preBlkCipher, BYTE* currBlkPlain, BYTE* CipherText) {
    mm_encrypt(tab, preBlkCipher, CipherText);
    xor_buf(currBlkPlain, CipherText, SKIPJACK_BLOCK_SIZE);
    mm_memcpy(preBlkCipher, CipherText, SKIPJACK_BLOCK_SIZE);
}
...
void my_main(){
    ...
    BYTE preBlkCipher[SKIPJACK_BLOCK_SIZE] = {0xf6, 0x43, 0x25, 0x1c, 0xd2, 0x43, 0x4, 0x4};
